...
import { Mail, Phone, Calendar, Camera, Award, Zap, Edit2, Star, Heart, MessageSquare } from "lucide-react"
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    ...
                    <div key={idx} className="flex items-center gap-3 pb-4 border-b border-slate-800/50 last:border-0">
